      ...
      transports: {
        ...
        taskModule: {
          ...
          authoring: {
            ...
            completeExampleNativePageTaskData: ["scrollDeltaY"],
            completeExamplePageKeyAliases: ["pageKey", "id"],
            completeExampleAmbiguousPageKeysAllowed: false,
            completeExampleNativeFactMode:
              "derive-expected-and-observed-from-authoritative-task-data",
            completeExampleInputValidation: "before-task-context",
            completeExampleStandardOutputFields: [
              "recordId", "pageKey", "pageId", "title", "body", "sourceUrl", "index",
            ],
            acceptanceAssertionSource: "explicit-user-or-authoritative-task-input-only",
            unknownAcceptanceValues: "omit-never-guess",
            requiredFieldSemantics: "present-and-meaningful-on-every-record",
            taskFactsContract: "expected-deep-subset-of-actual-with-exact-id-set",
            humanBehaviorRequirement: "runtime:behavior-mode",
