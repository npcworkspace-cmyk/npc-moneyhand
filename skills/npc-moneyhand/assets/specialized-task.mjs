...
// Copy this file into the specialized Skill and replace only executeTask(); keep run()
// and its lifecycle unchanged. MoneyHand rejects an unchanged copy by source fingerprint.
