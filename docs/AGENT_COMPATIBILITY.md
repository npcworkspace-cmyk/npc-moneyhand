...
| 交付物 | 版本 | 协议 | 最低运行环境 |
| --- | --- | --- | --- |
| `npc-moneyhand` Skill | `1.1.1` | `npc-moneyhand-control/1`、`npc-agent-jsonl/1` | Node.js 20+ |
| Skill 内置 controller | `1.1.1` | `npc-moneyhand-controller/2` | loopback `127.0.0.1:19845` |
| Chrome Extension | `1.1.1` | `npc-moneyhand/2` | Chrome/Chromium 125+ |
